...
import com.monica.rest.webservices.restfulwebservices.user.UserNotFoundException;
...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionResponse excRes = new ExceptionResponse(new Date(),"validation Failed", ex.getBindingResult().toString());
